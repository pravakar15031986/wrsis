                ...
                <section id="new">
                  ...
                  <div class="row">
		             ...
		             <div class="form-group">
		                ...
		                <div class="col-sm-3">
		                    <input type="text" class="form-control"  maxlength="50" id="companyName" value="Venus Tea Ltd" onkeypress="return checkCompanyName(event);"></input>
		                ...
		                <div class="col-sm-3">
		                    <input type="text" class="form-control"  maxlength="4" id="code" value="001"></input>
		                  </div>
		                  <label ></label>
		                  </div>
