...
display:none;
	...
	.swal>a{color:#fff;border:1px solid #ccc; display:inline-block; padding:10px; width:14.11%; text-align:center; transition:.3s;}
	.swal>a:hover{color:#ccc;  color:#fff;}
	
	.swal>a:nth-child(1){background:maroon;}
	.swal>a:nth-child(2){background:green;}
	.swal>a:nth-child(3){background:violet;}
	.swal>a:nth-child(4){background:orange;}
	.swal>a:nth-child(5){background:magenta;}
	.swal>a:nth-child(6){background:teal;}
	.swal>a:nth-child(7){background:red;}
  </style>
        ...
        <div class="col-xs-12">
          <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs">
              <li class="active"><a href="#forms" data-toggle="tab">Add</a></li>
              <li><a href="#ModalPopup" data-toggle="tab">Modals & Popups</a></li>
              <li><a href="#faIcons" data-toggle="tab">Fa Icons</a></li>
            ...
            <!-- /.box-body -->
		      ...
		      <div class="row">
		            ...
		            <div class="col-md-6">
		              ...
		              <!-- /.form-group -->
		              <div class="form-group">
		                <label>Disabled Select Result</label>
		                <select class="form-control select2" style="width: 100%;">
		                  <option selected="selected">Alabama</option>
		                  <option>Alaska</option>
				  ...
				  <div class="row">
		            ...
		            <div class="col-md-12">
		              <div class="form-group swal">
		                <a href="#" id="sa-basic">Basic Alert</a>
		                <a href="#" id="sa-title">With Title Alert</a>
		                <a href="#" id="sa-success">Success Alert</a>
		                <a href="#" id="sa-warning">Warning Alert</a>
		                <a href="#" id="sa-params">With Parameter Alert</a>
		                <a href="#" id="sa-image">Image Alert</a>
		                <a href="#" id="sa-close">Close Alert</a>
		              </div>
              ...
              <div class="tab-pane" id="ModalPopup">
