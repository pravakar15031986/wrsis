...
<div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
          <!-- small box -->
          <div class="small-box bg-grad4">
            <div class="inner">
              <h3>5</h3>

              <p>Application Forwarded</p>
            </div>
            <div class="icon">
  ...
  <div class="row">
          ...
          <div class="box box-success">
            <div class="box-header with-border">
              ...
              <div class="box-tools">
				<button type="button" class="btn btn-box-tool"><i class="fa fa-table"></i>
                </button>
      		...
      		<div class="box box-info direct-chat direct-chat-info">
                <div class="box-header with-border">
                  ...
                  <div class="box-tools pull-right">
                    <span data-toggle="tooltip" title="" class="badge bg-aqua" data-original-title="3 New Messages">3</span>
                    <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                    </button>
