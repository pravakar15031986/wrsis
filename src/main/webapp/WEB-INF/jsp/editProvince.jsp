                  ...
                  <div class="col-md-12">
		             ...
		             <div class="form-group">
		                ...
		                <div class="form-group">
		                  ...
		                  <div class="col-sm-4">
		                    <input type="text" class="form-control"  maxlength="20" id="province" value="Kilifi" onkeypress="return checkCountyName(event);"></input>
		                  </div>
		                  <label ></label>
		                  </div>
		                <div class="form-group">
		                 <label for="inputEmail3" class="col-sm-2 control-label">Province/County Code<span class="mandatory">*</span></label>
		                  <div class="col-sm-4">
		                    <input type="text" class="form-control"  maxlength="4" id="countyCode" value="6760" onkeypress="return checkCountyCode(event);"></input>
		                  </div>
		                  <label ></label>
		                </div>
			              ...
			              <label class="col-sm-2 control-label">Status</label>
			              	...
			              	<div class="col-sm-1">
								  ...
								  <input id="complist" type="radio" value="1" name="radio1" checked >
		                  ...
		                  <div class="col-sm-offset-2 col-sm-10">
		                   <a  href="viewProvince" type="reset" class="btn btn-default" >Back</a>
		                	<button type="submit" class="btn btn-info" onclick="return checkValidate();">Update</button>
		                  </div>
		                </div>
