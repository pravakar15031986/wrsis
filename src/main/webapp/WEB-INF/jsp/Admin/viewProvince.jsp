...
<form action="viewModifyCounty" name="modifyFrm" method="post">
<input type="hidden" name="csrf_token_" value="<c:out value='${csrf_token_}'/>"/>


	<input type="hidden" name="levelDetailId" id="levelDetailId"/>
	<input type="hidden" name="hierarchyID" value="${countyVo.hierarchyId}" />
	<input type="hidden" name="subnodeid" value="${countyVo.subHierarchyId}"/> 
</form>
<div class="row">
        ...
        <div class="col-xs-12">
          <div class="nav-tabs-custom">
           ...
           <ul class="nav nav-tabs">
             <li><a href="addCounty?hierarchyID=${countyVo.hierarchyId}&subnodeid=${countyVo.subHierarchyId}">Add</a></li>
              <li class="active"><a href="viewCounty?hierarchyID=${countyVo.hierarchyId}&subnodeid=${countyVo.subHierarchyId}" >View</a></li>
           </ul>
    ...
    <c:forEach items="${countyList}" var="vo" varStatus="counter">
