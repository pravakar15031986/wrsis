...
/*  Check Validation for Button Name */
	...
	/*  Check Validation for Description */
	 ...
	 /*#############TO check if button Master name is exist or not#########################*/

	 function chkDuplicateButtonName(but_name)
	 {
		// alert(but_name);
	       if(but_name=='') {return false;}else{
	     	  var xmlhttp;
	 ...
	 /*#############TO check if button Master File name is exist or not#########################*/

	 function chkDuplicateButtonMasterFileName(file_name)
	 {
	 	//alert(file_name);
	       if(file_name=='') {return false;}else{
	     	  var xmlhttp;
	           if(window.XMLHttpRequest)
	                {
	                xmlhttp=new   XMLHttpRequest();
        ...
        <div class="col-xs-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              ...
              <li class="active"><a href="addButtonMaster">Add</a></li>
              ...
              <div class="tab-pane active" id="fa-icons">
                <section id="new">
                  ...
                  <div class="col-md-12">
                  	...
                  	<form:form class="col-sm-12 form-horizontal customform" action="registerButtonMaster" modelAttribute="buttonVo" method="post">
...
<input type="hidden" name="csrf_token_" value="<c:out value='${csrf_token_}'/>"/>
		             ...
		             <div class="form-group">
		                ...
		                <div class="form-group">
		                  ...
		                  <div class="col-sm-4">
		                    <form:input type="text" class="form-control" path="buttonName" maxlength="20" id="buttonName" placeholder="Enter Button Name" onblur="chkDuplicateButtonName(this.value)" onkeypress="return checkButtonName(event);"></form:input>
		                  </div>
		                ...
		                <div class="form-group">
		                 <label for="inputEmail3" class="col-sm-2 control-label">Sl No</label>
		                  <div class="col-sm-4">
		                    <form:input type="text" class="form-control" path="sortNum" value="${maxSlNo}" maxlength="4" id="sortNum" placeholder="Enter Serial No" onkeypress="return checkSerial(event);" ></form:input>
		                  </div>
		                 ...
		                 <div class="form-group">
		                  ...
		                  <div class="col-sm-4">
		                    <form:input type="text" class="form-control" path="fileName" id="fileName" maxlength="20" placeholder="Enter File Name" onblur="chkDuplicateButtonMasterFileName(this.value)" onkeypress="return checkFileName(event);"></form:input>
		                  </div>
