   ...
   $('#funId').change(function() { //Spring Ajax call for Button master
		 ...
		 $.ajax({
            ...
            success : function(data) {  	             
                var html = '<option value="0">Select Button Name</option>';
				var len = data.length;
				//alert("len="+len);
				for ( var i = 0; i < len; i++) {
...
/*  Check Validation for Tab Name */
	...
	/*###########to check tab name already exist or not##########*/

	function chkDuplicateTabMasterName(tab_name)
	{ 
		//alert(tab_name);
		 if(tab_name=='') {return false;}else{
		var xmlhttp;
	...
	/*###########to check tab file name already exist or not##########*/

	function chkDuplicateTabFileName(tab_file_name)
	{ 
		//alert(tab_file_name);
		 if(tab_file_name=='') {return false;}else{
		var xmlhttp;
	    if(window.XMLHttpRequest)
	         {
	         xmlhttp=new   XMLHttpRequest();
	    ...
	    xmlhttp.onreadystatechange=function()
	    {
	         ...
	         if (xmlhttp.readyState==4 && xmlhttp.status==200)
	         {
	             ...
	             if(res_text!="NotExist")
	                         {
	                         alert("Tab file name in this Button is already exist.");
	                         $("#url").val("");
	                         $("#url").focus(); 
	                         }
	         }
        ...
        <div class="col-xs-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="addTabMaster" >Add</a></li>
              ...
              <div class="tab-pane active" id="fa-icons">
                <section id="new">
                  ...
                  <div class="row">
                  	...
                  	<form:form class="col-sm-12 form-horizontal customform" action="registerTabMaster" modelAttribute="tabMasterVo" method="post">
...
<input type="hidden" name="csrf_token_" value="<c:out value='${csrf_token_}'/>"/>
		             ...
		             <div class="form-group">
		                ...
		                <div class="form-group">
		                  ...
		                  <div class="col-sm-4">
		                    <form:input type="text" class="form-control" path="tabName" id="tabName" maxlength="20" placeholder="Enter Tab Name" onblur="chkDuplicateTabMasterName(this.value)" onkeypress="return checkTabName(event);"></form:input>
		                  </div>
		                ...
		                <div class="form-group">
		                 <label for="inputEmail3" class="col-sm-2 control-label">Sl No</label>
		                  <div class="col-sm-4">
		                    <form:input type="text"  class="form-control" path="intSortNum" value="${maxSlNo}" maxlength="4" id="sortNum" placeholder="Enter Serial No"  onkeypress="return checkSerial(event);"></form:input>
		                  </div>
		                 ...
		                 <div class="form-group">
		                  ...
		                  <div class="col-sm-4">
		                    <form:input type="text" class="form-control" path="fileName" maxlength="30" id="fileName" placeholder="Enter File Name" onblur="chkDuplicateTabFileName(this.value)" onkeypress="return checkFileName(event);"></form:input>
		                  </div>
