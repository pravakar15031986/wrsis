        ...
        <div class="col-xs-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="addComany?hierarchyID=${companyvo.hierarchyId}&subnodeid=${companyvo.subHierarchyId}" >Add</a></li>
            ...
            <div class="tab-content">
              ...
              <div class="tab-pane active" id="fa-icons">
                <section id="new">
                  ...
                  <div class="row">
                  <form:form  action="registerCompany" modelAttribute="companyvo" method="post">
