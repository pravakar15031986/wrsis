        ...
        <div class="col-xs-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
             ...
             <li class="active"><a href="addCounty?hierarchyID=${countyVo.hierarchyId}&subnodeid=${countyVo.subHierarchyId}"">Add</a></li>
            ...
            <div class="tab-content">
              ...
              <div class="tab-pane active" id="fa-icons">
                <section id="new">
                  ...
                  <form:form  action="registerCounty" modelAttribute="countyVo" method="post">
