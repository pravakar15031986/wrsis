   ...
   function checkValidate(){
	   ...
	   return false;
		...
		if (document.getElementById("functionId").value == 0)
		{
		 ...
		 /*  var check = document.getElementsByName('r1');
	     var checkValue = false;
	        ...
	        if(!checkValue){
	            alert("Please Choose the Link Type.");
	            return false;
	        } 
		 */
...
/*  Check Validation for Serial Number */
 ...
 function chkDuplicateUpdPrimaryLName(PLname,path)
 {     
 	if(PLname=='') {return false;}
 	else if(path==PLname){return false;}else{
              var xmlhttp;
    ...
    <div class="mainpanel">
    	    <form action="viewPrimaryLink" method="get" id="cancelForm">
               ...
               <div class="row">
                  <div class="col-md-12 col-sm-12">
                     <div class="card">
                        ...
                        <form:form class="col-sm-12 form-horizontal customform" action="updatePrimarylink" modelAttribute="primarylinkVo" method="post" autocomplete="off">
<input type="hidden" name="csrf_token_" value="<c:out value='${csrf_token_}'/>"/>

                        
		             <form:hidden path="primaryLinkId"></form:hidden> 
                        ...
                        <div class="card-body">
                           ...
                           <div class="form-group row">
                             ...
                             <div class="form-group row">
                              ...
                              <div class="col-12 col-md-6 col-xl-4"><span class="colon">:</span>
							<form:input  class="form-control" path="primaryLinkName" id="primaryLinkName" maxlength="50" placeholder="Enter Primary Key" onkeypress="return checkprimaryLinkName(event);"></form:input>                              
                             ...
                             <div class="form-group row">
                              ...
                              <div class="col-12 col-md-6 col-xl-4"><span class="colon">:</span>
                              <form:input readonly="true" class="form-control" path="slNo" value="${maxSlNumber}" id="slNo" maxlength="4" placeholder="Enter Serial No" onkeypress="return checkSerialNo(event);" ></form:input>
        ...
        <div class="col-xs-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="editPrimaryLink" >Edit</a></li>
                ...
                <section id="new">
                  ...
                  <div class="row">
		             ...
		             <div class="form-group">
		                  <label for="inputEmail3" class="col-sm-2 control-label">Global Link</label>
		                  <div class="col-sm-4">
		                <form:select path="globalLinkId" id="globalId" class="form-control select2" style="width: 100%;" >
				          <option value="0">Select Global Link</option>
     			          <form:options items="${globalList}" itemValue="globalLinkId" itemLabel="globalLinkName" />
		                ...
		                <div class="form-group">
		                  <label for="inputEmail3" class="col-sm-2 control-label">Primary Link<span class="mandatory">*</span></label>
		                  <div class="col-sm-4">
		                    <form:input type="text" class="form-control" path="primaryLinkName" id="primaryLinkName" maxlength="50" placeholder="Enter Primary Key" onblur="chkDuplicateUpdPrimaryLName(this.value,'${primarylinkVo.primaryLinkName}')" onkeypress="return checkprimaryLinkName(event);"></form:input>
		                  </div>
		                ...
		                <div class="form-group">
		                 <label for="inputEmail3" class="col-sm-2 control-label">Sl No</label>
		                  <div class="col-sm-4">
		                    <form:input type="text" class="form-control" path="slNo" id="slNo" maxlength="4" onkeypress="return checkSerialNo(event);"></form:input>
		                  </div>
                ...
                <label>
                  External
                   ...
                   <div class="form-group">
					      ...
					      <form:select path="functionId" id="functionId" name="functionName" class="form-control select2" style="width: 100%;" >
				          <option value="0">Select Function Name</option>
     			          <form:options items="${functionList}" itemValue="functionId" itemLabel="functionName" />
					      </form:select> 
		                  </div>
