...
<script>
function editButtonMaster(buttonId){
	//alert(buttonId);
	 $("#hdnButtonId").val(buttonId);
    $("form[name='form']").submit();
		}

function deleteButtonMaster(buttonId,status){
	//alert(buttonId);
	 $("#hiddenButtonId").val(buttonId);
...
<form:form action="editButtonMaster" name="form" method="post">
<input type="hidden" name="csrf_token_" value="<c:out value='${csrf_token_}'/>"/>


<input type="hidden" name="buttonId" id="hdnButtonId"/>
</form:form>

<form:form action="deleteButtonMaster" name="form1" method="post">
<input type="hidden" name="csrf_token_" value="<c:out value='${csrf_token_}'/>"/>


<input type="hidden" name="buttonId" id="hiddenButtonId"/>
        ...
        <div class="col-xs-12">
          <div class="nav-tabs-custom">
           ...
           <ul class="nav nav-tabs">
              <li><a href="addButtonMaster">Add</a></li>
              <li class="active"><a href="viewButtonMaster" >View</a></li>
            </ul>
          ...
          <div class="row">
            <div class="col-md-12">
               ...
               <section id="new">
                  ...
                  <div class="row">
                  	 <form:form class="col-sm-12 form-horizontal customform" action="viewButtonMaster"  method="get" modelAttribute="searchVo">
...
<input type="hidden" name="csrf_token_" value="<c:out value='${csrf_token_}'/>"/>
    ...
    <c:forEach items="${buttonList}" var="vo" varStatus="counter">
 ...
 <tr>
    ...
    <td><a data-placement="top" data-toggle="tooltip" title="Edit" onclick="editButtonMaster('${vo.buttonId}',1);"><button class="btn btn-primary btn-xs" data-title="Edit" data-toggle="modal" data-target="#edit" ><span class="glyphicon glyphicon-pencil"></span></button></a></td>
    <td><a data-placement="top" data-toggle="tooltip" title="Delete" onclick="deleteButtonMaster('${vo.buttonId}','${vo.bitStatus}');"><button class="btn btn-danger btn-xs" data-title="Delete" data-toggle="modal" data-target="#delete" ><span class="glyphicon glyphicon-trash"></span></button></a></td>
    </tr>
    </c:forEach>
    </tbody>
