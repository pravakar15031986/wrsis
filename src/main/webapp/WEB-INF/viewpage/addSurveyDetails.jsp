...
<div class="mainpanel">
                     ...
                     <div class="card">
                        <div class="card-header">
                           <ul class="nav nav-tabs nav-fill" role="tablist">
                              <a class="nav-item nav-link active"  href="addSurveyDetails">Add</a>
                              <a class="nav-item nav-link "  href="viewsurveydetails" >View</a>
                           </ul>
      ...
      <tr>
	      ...
	      <td><input type="number" id="severityId"  max="100" min="0" step="1" class="form-control" placeholder=""></td>
	             ...
	             <div class="radio">
	                ...
	                <label for="demo-form-radio-6">No</label>
                          ...
                          <div class="table-responsive">
      							    ...
      							    <form action="validateSurveyDetails" autocomplete="off" id="myForm"   method="post" enctype="multipart/form-data">
               			  ...
               			  <div class="row noimage">
	                            <label class="col-12 col-md-2 col-xl-2 control-label">Uploaded Images</label>
			                       ...
			                       <a href="${images }" data-thumbnail="${images }" data-group="mygroup" class="html5lightbox thumbimg" title="Toronto">  <img alt="no image" src="${images }" style="width: 160px;height:160px;"></a>
														</c:forEach>
                          ...
                          <%-- <c:if test="${Update eq false && SurveyId eq 0}">
               			  ...
               			  <div class="row noimage">
	                            <label class="col-12 col-md-2 col-xl-2 control-label">Uploaded Images</label>
			                       ...
			                       <a href="${images }" data-thumbnail="${images }" data-group="mygroup" class="html5lightbox thumbimg" title="Toronto">  <img src="${images }" style="width: 160px;height:160px;"></a>
														</c:forEach>
...
function createInputField(fieldCount){
	...
	for(i=0;i<fieldCount;i++){
		...
		html+="<input type='text' maxlength='20' class='form-control' id='"+sampleId+"' /><br>"
	}
		 ...
		 try
			{
				...
				if(isNaN(temp))
					...
					swal(
	        				'Error!',
	        				'Please enter valid '+vt1+' perecentage.',
	        				'error'
	        			) 
					return false;
					}
