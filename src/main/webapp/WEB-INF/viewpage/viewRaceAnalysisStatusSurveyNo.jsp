            ...
            <div class="section">
                  ...
                  <div class="col-md-12 col-sm-12">
                     <div class="card">
                           ...
                           <div class="indicatorslist">
                             <a title="" href="javascript:void(0)" onclick="history.back();" data-toggle="tooltip" data-placement="top" data-original-title="Back"><i class="icon-arrow-left1"></i></a>
                           </div>
                        </div>
						...
						<div class="table-responsive">
							<table class="table table-bordered" id="rustTable">
							<tr>
								<th>Sl#</th>
								<th>Type of Rust</th>
								<th>Incident(%)</th>
	          ...
	          <div class="col-12 col-md-8 col-xl-8">
	            ...
	            <span id="sampleCollected"></span>
					        ...
					        <div class="tablesec">
								<div class="table-responsive">
									<table  class="table table-bordered" id="sampleDetail">
									<tr>
										<th>Sl#</th>
                       ...
                       <div class="row noimage">
	                       ...
	                       <c:forEach items="${Images}" var="images"
							 ...
							 <div class="col-md-2">					
	                      <a href="${images}" data-thumbnail="${images}" data-group="mygroup" class="html5lightbox thumbimg" title="Syrvey Images">  <img src="${images}" alt="image" style="width: 160px;height:160px;"></a>
	                         </div>
												</c:forEach>
							...
							<div class="tablesec">
								<div class="table-responsive">
									<table class="table table-bordered" id="otherDisease1">
									<tr>
										<th>Sl#</th>
										<th>Disease</th>
										<th>Incident (%)</th>
                          ...
                          <div class="width50">
                            ...
                            <div class="form-group row">
							  ...
							  <div class="col-12 col-md-8 col-xl-8">
								 ...
								 <a class="btn btn-success mb-1" id="btnBack" href="javascript:void(0)" onclick="history.back()">Back</a>
							  </div>
					      </div>
                           ...
                           <form action="viewRaceAnalysisStatusSurveyNo" autocomplete="off" id="myForm"   method="post">
