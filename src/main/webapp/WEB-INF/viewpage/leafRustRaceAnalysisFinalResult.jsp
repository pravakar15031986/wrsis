                     ...
                     <div class="card">
                        <div class="card-header">
                           <ul class="nav nav-tabs nav-fill" role="tablist">
                              ...
                              <a class="nav-item nav-link active "  href="leafRustRaceAnalysisFinalResult" >View</a>
                           </ul>
                          ...
                          <div class="width50">
                           ...
                           <div class="form-group row">
                             ...
                             Upload File
                               ...
                               <div class="col-sm-3">
                                  <input type="file" id="demo-text-input1" class="form-control" placeholder="">
                              </div>
                           </div>
                           ...
                           <div class="form-group row" >
							  <div class="col-12 col-md-8 col-xl-8">
								 ...
								 <button class="btn btn-info mb-1" id="btnSubmitId">Publish</button>
