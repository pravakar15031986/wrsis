	...
	<div class="section">
		...
		<div class="row">
			<div class="col-md-12 col-sm-12">
				<div class="card">
					<div class="card-header">
						<ul class="nav nav-tabs nav-fill" role="tablist">
							<a class="nav-item nav-link active" href="advisorypending">Pending Advisory</a>
							<a class="nav-item nav-link" href="advisorypublished">Published Advisory</a>
						</ul>
					...
					<!-- Search Panel -->
						...
						<form class="col-sm-12 form-horizontal customform" action="advisorypendingSearch" method="post" autocomplete="off">
				...
				<form action="editadvisoryApp" method="post" id="editForm">
				<input type="hidden" name="csrf_token_" value="<c:out value='${csrf_token_}'/>"/>
