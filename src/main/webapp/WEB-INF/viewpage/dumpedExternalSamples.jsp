            ...
            <div class="section">
               <div class="page-title">
                  <div class="title-details">
                     <h4>View Dumped Samples</h4>
                     <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                           <li class="breadcrumb-item"><a href="Home"><span class="icon-home1"></span></a></li>
                           <li class="breadcrumb-item">Manage Race Analysis</li>
                           <li class="breadcrumb-item active" aria-current="page">Dumped Samples</li>
                        </ol>
                     </nav>
                  </div>
                     ...
                     <div class="card">
                        <div class="card-header">
                           <ul class="nav nav-tabs nav-fill" role="tablist">
                              <a class="nav-item nav-link active"  href="dumpedExternalSamples">Dumped Samples</a>
                           </ul>
                             
                        </div>
                        <!-- Search Panel -->
                        <form class="col-sm-12 form-horizontal customform" action="dumpedExternalSamples"  method="post" autocomplete="off">   
                       <input type="hidden" name="csrf_token_" value="<c:out value='${csrf_token_}'/>"/>
                              ...
                              <label class="col-lg-2 ">Survey No.</label>
                              	...
                              	<label class="col-lg-2 ">Survey Date From</label>
                                    <div class="input-group col-lg-3">
                                       <input type="text" class="form-control datepicker" data-date-end-date="0d" name="surveyDateFrom" id="surveyDateFrom" aria-label="Default" value="${surveyDateFrom}" aria-describedby="inputGroup-sizing-default"/>
                                 ...
                                 <label class="col-lg-2 ">Survey Date To </label>
                                    <div class="input-group col-lg-3">
                                       <input type="text" class="form-control datepicker" data-date-end-date="0d" name="surveyDateTo" id="surveyDateTo"  value="${surveyDateTo}" aria-label="Default" aria-describedby="inputGroup-sizing-default"/>
                                       <div class="input-group-append">
											<span class="input-group-text" id="inputGroup-sizing-default"><i class="icon-calendar1"></i></span>
										</div>
                                    </div>
                        ...
                        <form action="viewSurveyDetailsOnDumpedSample" autocomplete="off" id="myForm1"   method="post">
                        <input type="hidden" name="csrf_token_" value="<c:out value='${csrf_token_}'/>"/>
                                   <input type="text" value="" style="display:none;" name="surveyId" id="surveyId1">
                                <input type="hidden"   name="r_url" value="dumpedExternalSamples">
                                 </form>
                        <!-- Search Panel -->
                        <!--===================================================-->
...
$(function() {
	 ...
	 $('#myTable').dataTable({
	      ...
	      "ordering": false, 
			 "ajax" : {
					"url" : "dumpedExternalSamplesByPageWise",
					"data" : function(d) {
