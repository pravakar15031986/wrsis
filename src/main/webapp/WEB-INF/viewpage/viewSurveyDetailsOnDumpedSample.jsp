                  ...
                  <div class="title-details">
                     ...
                     <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                           ...
                           <li class="breadcrumb-item">Dumped Samples</li>
                        </ol>
                     </nav>
                  </div>
                  ...
                  <div class="col-md-12 col-sm-12">
                     <div class="card">
                           ...
                           <div class="indicatorslist">
                             <a title="" href="${r_url}"  data-toggle="tooltip" data-placement="top" data-original-title="Back"><i class="icon-arrow-left1"></i></a>
                           </div>
                        </div>
