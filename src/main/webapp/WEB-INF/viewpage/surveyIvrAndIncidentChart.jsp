                     ...
                     <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                           ...
                           <li class="breadcrumb-item">MIS Reprt</li>
                            <li class="breadcrumb-item"><a href="surveyAndIvrReport">Survey, Ivr And Incident Chart</a></li>
                           <li class="breadcrumb-item active" aria-current="page">Survey, Ivr And Incident Chart</li>
                        </ol>
                     </nav>
                  </div>
                     ...
                     <div class="card">
                        <div class="card-header">
                           <ul class="nav nav-tabs nav-fill" role="tablist">
                              <a class="nav-item nav-link 	active"  href="surveyIvrAndIncidentChart">View</a>
                           </ul>
                            <div class="indicatorslist">
                           <a  title="" href="surveyAndIvrReport" id="backIcon" data-toggle="tooltip" data-placement="top" data-original-title="Back"><i class="icon-arrow-left1"></i></a>
                          </div>
...
<script src="wrsis/js/canvasjs.min.js"></script>
  ...
  window.onload = function () {
    var chart = new CanvasJS.Chart("chartContainer",
    {
      ...
      title:{
        text: "Zone Wise Comparison Between Survey, Ivr and Incident"       
      },
	  axisY: {
