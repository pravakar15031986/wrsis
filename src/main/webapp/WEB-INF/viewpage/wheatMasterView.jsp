                     ...
                     <div class="card">
                        <div class="card-header">
                           <ul class="nav nav-tabs nav-fill" role="tablist">
                              <a class="nav-item nav-link "  href="wheatMaster">Add</a>
                              <a class="nav-item nav-link active"  href="wheatMasterView" >View</a>
                           </ul>
                        ...
                        <div class="search-container">
                           <div class="search-sec">
                              ...
                              <div class="form-group">
                                 <div class="row">
                                    <label class="col-lg-2 ">Type of Wheat</label>
                                    <div class="col-lg-3">
                                    ...
                                    <div class="col-lg-2">
                                       <button class="btn btn-primary" id="search" onclick="searchSample(10,1)"> <i class="fa fa-search"></i> Search</button>
                                    </div>
                                 </div>
                              </div>
                           </div>
						...
						<div style="float: right;" id="pageId">
                            ...
                            <form action="edit-type-wheat" id="editForm" method="post">
                         
<input type="hidden" name="csrf_token_" value="<c:out value='${csrf_token_}'/>"/>

                           <input type="hidden" id="id" name="wheatTypeId">
                           </form>
	...
	$.ajax({
			...
			success:function(response){
				...
				for(var i=array0.startPage;i<=array0.endPage;i++)
				{
				 ...
				 if(val!=" " || val!=null )
				{
					 listDataLen=listDataLen+val.wheatList.length-backUp;
  					 var dataLen=val.wheatList.length;
					 var indexLen=listDataLen-dataLen;
					
					$.each(val.wheatList,function(index,value)
					{
...
function search(){
	...
	if(name == "")
	{
		swal("Error", "Please enter the Fungicide Name", "error");
        return false;
	}
