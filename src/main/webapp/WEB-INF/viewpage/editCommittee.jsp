...
<div class="mainpanel">
	<form action="viewCommittee" method="get" id="cancelForm">
               ...
               <div class="row">
                  <div class="col-md-12 col-sm-12">
                     <div class="card">
                        ...
                        <!-- BASIC FORM ELEMENTS -->
                        <!--===================================================-->
                        <form:form action="updateCommittee" method="post" id="committeeForm" modelAttribute="committeeDetails" autocomplete="off" >
                      <input type="hidden" name="csrf_token_" value="<c:out value='${csrf_token_}'/>"/>
                        <form:input path="committeeId" type="hidden"/>
                        <div class="card-body">
                           <!--Static-->
                           <!--Text Input-->
                             <div class="width50">
                             <div class="form-group row">
                              ...
                              <div class="col-12 col-md-8 col-xl-8"><span class="colon">:</span>
                                <form:input type="text" path="committeeName" id="center-text-input"  class="form-control" placeholder="Enter committee name" maxlength="50" />
                              </div>
                           </div>
                           <div class="form-group row">
                           ...
                           <div class="form-group row">
							  ...
							  <div class="col-12 col-md-8 col-xl-8">
								 ...
								 <button type="button" class="btn btn-danger mb-1" id="btnCancelId" onclick="return cancel()">Cancel</button>
							  </div>
					      </div>
                        </div>
                     </div>
