                     ...
                     <div class="card">
                        <div class="card-header">
                           <ul class="nav nav-tabs nav-fill" role="tablist">
                              <a class="nav-item nav-link active"  href="addTypeofRust">Add</a>
                        ...
                        <div class="card-body">
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-12 col-md-6 col-xl-4"><span class="colon">:</span>
                                 <form:input tabindex="1" id="demo-text-input1" path="typeOfRust" class="form-control" placeholder="Type of Rust" maxlength="50" autofocus="autofocus"/>
                            ...
                            <div class="form-group row">
                             ...
                             <div class="form-group row pad-ver">
                              ...
                              <span class="colon">:</span>
                                 <div class="radio">
                                    <form:radiobutton id="demo-form-radio" value="false" class="magic-radio sampleyes" path="isDelete"  checked="checked"/>
                                    <label for="demo-form-radio" tabindex="4">Active</label>
                             
                                    <form:radiobutton id="demo-form-radio-2" value="true" path="isDelete" class="magic-radio sampleno" />
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-12 col-md-6 col-xl-4">
                                 <button class="btn btn-primary mb-1" id="btnSubmitId" tabindex="6">Submit</button>
                                 <button type="reset" class="btn btn btn-danger mb-1" id="btnResetId" tabindex="7">Reset</button>
                              </div>
                           </div>
                        </div>
                        </form:form>
	   ...
	   $('#btnSubmitId').click(function()
		{
       	...
       	{
       		swal("Error", "Type of Rust accept only alphabets", "error");
   			return false;
       	}
		var shortName=$('#demo-text-input2').val();
		 ...
		 if(shortName.charAt(0)== ' ' || shortName.charAt(shortName.length - 1)== ' '){
			   swal("Error", "White space is not allowed at initial and last place in Short Name", "error");
	            return false;
		   }
		 if(shortName!=null)
	       	{
