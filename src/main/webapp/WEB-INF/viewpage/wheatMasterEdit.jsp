...
<div class="mainpanel">
<form action="wheatMasterView" id="viewForm" method="get">
...
<input type="hidden" name="csrf_token_" value="<c:out value='${csrf_token_}'/>"/>
                          ...
                          <form:hidden path="wheatTypeId"/>
                           <div class="form-group row">
                              ...
                              <div class="col-12 col-md-8 col-xl-8"><span class="colon">:</span>
                                 <form:input tabindex="1" id="center-text-input" class="form-control" placeholder="Type of Wheat" maxlength="50" path="wheatName" />
                              </div>
                           </div>
                          <div class="form-group row">
						  ...
						  <div class="form-group row">
							...
							<button class="btn btn-primary mb-1" onclick="return save();" id="btnUpdateId" tabindex="5">Update</button> 	<!--   -->
								 <button class="btn btn-danger mb-1" id="btnCancelId" onclick="cancel()" tabindex="6">Cancel</button>
							  </div>
					      </div>
                         </form:form>
                        </div>  
...
function save()
  ...
  function cancel(){
	  /* window.location.href="wheatMasterView"; */
	  $("#viewForm").submit();
}
      </script>
      <script>
