                  ...
                  <div class="col-md-12 col-sm-12">
                     <div class="card">
                        ...
                        <input type="hidden" name="csrf_token_" value="<c:out value='${csrf_token_}'/>"/>
                           <!--Static-->
                           <!--Text Input-->
                           <%-- <form action="add-userType.htm" autocomplete="off" method="post" id="userForm"> --%> 
                            ...
                            <div class="form-group row">
                              ...
                              <span class="colon">:</span>
                                 <div class="radio">
                                    ...
                                    <form:radiobutton path="isDelete" value="true" id="demo-form-radio" class="magic-radio sampleyes" name="form-radio-button" checked="checked"/>
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-12 col-md-6 col-xl-4">
                                 <button id="btnSubmitId" class="btn btn-primary mb-1" type="button" >Submit</button>
