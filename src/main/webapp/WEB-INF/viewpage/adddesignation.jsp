                  ...
                  <div class="col-md-12 col-sm-12">
                     <div class="card">
                        <div class="card-header">
                           ...
                           <li class="active"><a class="nav-item nav-link active" href="adddesignation" >Add</a></li>
                           <li><a class="nav-item nav-link " href="viewdesignation" >View</a></li>
                           </ul>
                        ...
                        <div class="card-body">
                          <form:form  action="saveDesignation" modelAttribute="designation" method="post" autocomplete="off" >
                             ...
                             <div class="width50">
									...
									<div class="form-group row">
										...
										<div class="col-12 col-md-8 col-xl-8">
											...
											<form:input tabindex="1" type="text" path="designation" id="designationId" maxlength="50" class="form-control" placeholder="Designation" onkeypress="return blockSpecialAlphabet(event)"></form:input>
										</div>
									</div>
									<div class="form-group row">
									...
									<div class="col-12 col-md-8 col-xl-8">
									 <span class="colon">:</span>
										<div class="radio">
											  <form:radiobutton path="status" value="false" id="demo-form-radio" class="magic-radio sampleyes" name="form-radio-button" checked="checked"/>
                           ...
                           <div class="form-group row">
							  ...
							  <div class="col-12 col-md-8 col-xl-8">
                                 <button class="btn btn-primary mb-1" id="btnSubmit" onclick="return checkValidate();" tabindex="5">Submit</button>
                                 <button type="reset" class="btn btn btn-danger mb-1" tabindex="6">Reset</button>
                              </div>
                           </div>
                           </div>
                           </form:form>
