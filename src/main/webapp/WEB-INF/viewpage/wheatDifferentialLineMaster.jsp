	...
	<div class="section">
		<div class="page-title">
			<div class="title-details">
				<h4>Add Wheat Differential Line</h4>
					...
					<div class="card-header">
						<ul class="nav nav-tabs nav-fill" role="tablist">
							<a class="nav-item nav-link active"
								href="wheatDifferentialLineMaster">Add</a>
...
<input type="hidden" name="csrf_token_" value="<c:out value='${csrf_token_}'/>"/>
								...
								<div class="form-group row hidsec divseqno">
								...
								<div class="form-group row hidsec divseedsrc">
								...
								<div class="form-group row hidsec divgene">
									<label class="col-12 col-md-4 col-xl-4 control-label"
								...
								<div class="form-group row hidsec divexplowit">
									<label class="col-12 col-md-4 col-xl-4 control-label"
								...
								<div class="form-group row">
									...
									<div class="col-12 col-md-8 col-xl-8">
										<button class="btn btn-primary mb-1" id="btnSubmitId"
											tabindex="11">Submit</button>
										<button class="btn btn-danger mb-1" type="reset"
											id="btnResetId" tabindex="12">Reset</button>
									</div>
								</div>
							</form:form>
						</div>
...
<script>
      $(document).ready(function(){
		  var html="";
    	  for(i=1;i<="${diffsetno}";i++ )
        	  {
				html+="<option value="+i+" >"+i+"</option>";
        	 }
    	  $("#diffSetNoId").append(html);
      });
</script>
<script>
$(document).ready(function(){
