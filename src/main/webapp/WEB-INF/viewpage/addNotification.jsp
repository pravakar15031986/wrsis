...
<div class="mainpanel">
                     ...
                     <div class="card">
                        <div class="card-header">
                           <ul class="nav nav-tabs nav-fill" role="tablist">
                              <a class="nav-item nav-link active"  href="addNotification">Add</a>
                        ...
                        <!-- BASIC FORM ELEMENTS -->
                        <!--===================================================-->
                        <form:form action="saveNotification" id="notificationForm" name="ntfForm" modelAttribute="notificationDetails" autocomplete="off">
                        ...
                        <div class="card-body">
                           ...
                           <!--Text Input-->
                             ...
                             <div class="form-group row">
										...
										<span class="colon">:</span>
											 <form:select class="form-control" id="organizationId" path="organizationId" onchange="getUsers();">
												<form:option value="0">--Select--</form:option>
												<form:options items="${orgList}" itemLabel="levelName" itemValue="levelDetailId" />
											</form:select>
										</div>
									</div>
									<div class="form-group row researchcenter" id="researchCenterDivId">
										<label class="col-12 col-md-4 col-xl-4 control-label"
											for="demo-email-input">Research Center<span
											class="text-danger">*</span></label>
										<div class="col-12 col-md-8 col-xl-8">
										<span class="colon">:</span>
											 <form:select class="form-control" id="researchCenterId" path="rcId" onchange="getUsers();">
												<form:option value="0">--Select--</form:option>
                        	...
                        	<div class="form-group row">
                              <label class="col-12 col-md-4 col-xl-4 control-label" for="demo-email-input">Notification Message<span class="text-danger">*</span></label>
                              <div class="col-12 col-md-8 col-xl-8">
                                 <span class="colon">:</span>
                                 <form:textarea path="notificationMsg" id="descriptionID" rows="4" class="form-control" placeholder="Message" maxlength="160" /><div id="charNum"></div>

                              </div>
                           </div> 
                           <div class="form-group row">
                              <label class="col-12 col-md-4 col-xl-4 control-label">Action </label>
                              <div class="col-12 col-md-8 col-xl-8">
                              <span class="colon">:</span>
                                 <div class="radio">
                                    <form:radiobutton id="sendNow" value="true" class="magic-radio" path="sendStatus" name="sendStatus" checked="checked"/>
                           ...
                           <div class="form-group row">
							  ...
							  <div class="col-12 col-md-8 col-xl-8">
								 ...
								 <a href="addNotification" class="btn btn-danger mb-1" type="button" id="btnResetId">Reset</a>
							  </div>
					      </div>
                        </div>
                     </div>
                  </form:form>
                  <%-- <form:form action="saveAndSendNotification" id="sendForm" modelAttribute="notificationDetails">
    ...
    radio.change(function(e) {
        ...
        if (choice === 'false') {
            /* form.attr('action', 'saveNotification'); */
            $('.scheduleNtf').show();
        } else {
            /* form.attr('action', 'saveAndSendNotification'); */
            $('.scheduleNtf').hide();
            $('#ntfDate').val("");
        }
    });
    ...
    $(document).ready(function(){
         ...
         radio = $('input[name="sendStatus"]'),
         choice = '';
       if ($('input[name="sendStatus"]').val() === 'false') {
    	   /* form.attr('action', 'saveNotification'); */
            $('.scheduleNtf').show();
        } else if($('input[name="sendStatus"]').val() === 'true') {
        	/* form.attr('action', 'saveAndSendNotification'); */
            $('.scheduleNtf').hide();
            $('#ntfDate').val("");
        }
...
$(document).ready(function(){
	 var text_max = 160;
	 $('#btnResetId').click(function() {
		 $('#charNum').html('Maximum characters :' + '160');
	 });
...
function getUsers()
{
	...
	//alert(levelDetailId + " " + rcId + " " + roleId )
	/* if(roleId==0)
	{
		$('#usersId').empty();
		return false;
