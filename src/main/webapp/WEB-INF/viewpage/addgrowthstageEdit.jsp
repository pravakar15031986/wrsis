...
<div class="mainpanel">
<form action="viewgrowthstage" method="get" id="cancelForm"></form>
          <input type="hidden" name="csrf_token_" value="<c:out value='${csrf_token_}'/>"/>
            <div class="section">
               <div class="page-title">
                  <div class="title-details">
                     <h4>Edit Crop Growth Stage</h4>
                        ...
                        <div class="card-body">
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-12 col-md-6 col-xl-4"><span class="colon">:</span>
                                 <form:input tabindex="1" path="stageName" id="demo-text-input1" maxlength="50" class="form-control" placeholder="Growth Stage"/>
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-12 col-md-6 col-xl-4"><span class="colon">:</span>
                                 <form:textarea tabindex="2" path="description" id="descriptionId" rows="4" class="form-control" placeholder="Description" maxlength="200" onkeyup="countChar(this)"/><div id="charNum">Maximum 200 characters</div>
                              </div>
                           </div>
                           <div class="form-group row pad-ver">
                              ...
                              <span class="colon">:</span>
                                 <div class="radio">
                                    <form:radiobutton path="status" id="demo-form-radio" value="0" class="magic-radio sampleyes"  name="form-radio-button" />
