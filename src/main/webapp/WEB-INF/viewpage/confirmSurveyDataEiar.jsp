 ...
 <div class="mainpanel">
        ...
        <div id="imageShow">   
	                       ...
	                       <div class="row noimage">
			                       ...
			                       <a href="${images }" data-thumbnail="${images }" data-group="mygroup" class="html5lightbox thumbimg" title="Toronto">  <img src="${images }" alt="capturedImage" style="width: 160px;height:160px;"></a>
														</c:forEach>
	                        ...
	                        <h3>Fungicide Details</h3>
	                         <div class="form-group row pad-ver width50">
                          ...
                          <div class="width50">
                           ...
                           <div class="form-group row">
                            ...
                            <div class="clearfix"></div>
                       	  ...
                       	  <form action="saveSurveyDetailsEiar" autocomplete="off" id="myForm"   method="post">
	 ...
	 swal({
 		title: ' Do you want to Modify?',
 		  ...
 		  cancelButtonText: 'No',
	    	  ...
	    	  if (result.value) { 
	    		  window.location.href="modifySurveyEiar?surveyId="+'${SurveyId}';
	    		  }
	    		})  
	    		return false; 
	});
	...
	swal({
 		title: ' Do you want to Cancel?',
 		  ...
 		  cancelButtonText: 'No',
	    	  ...
	    	  if (result.value) { 
	    		  window.location.href="cancelSurveyDetailsEiar";
	    		  }
	    		})  
	    		return false;   
});
