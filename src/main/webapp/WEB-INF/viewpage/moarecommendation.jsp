			...
			<div class="title-details">
				...
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item" aria-current="page">MOA
							Recommendation</li>
					</ol>
				</nav>
			</div>
				...
				<div class="card">
					<div class="card-header">
						<ul class="nav nav-tabs nav-fill" role="tablist">
							<a class="nav-item nav-link active" href="moarecommendation">View</a>
					...
					<form:form class="col-sm-12 form-horizontal customform"
						action="moarecommendationsSearch" method="post"
						...
						<div class="table-responsive">
							<table data-toggle="table"
								...
								<thead>
									<tr>
										<th width="40px">Sl#</th>
										<th class="text-center">Recommendation no.</th>
										<th class="text-center">Recommendation Date</th>
...
"ordering": false, 
"ajax" : {
	"url" : "moarecommendationPage",
	"data" : function(d) {
		d.startDate =$("#recDtFrom").val();
		d.endDate = $("#recDtTo").val();
