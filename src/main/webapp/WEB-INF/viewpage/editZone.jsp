...
<div class="mainpanel">
  <form action="viewzone" method="get" id="cancelForm"><input type="hidden" name="csrf_token_" value="<c:out value='${csrf_token_}'/>"/></form>
            <div class="section">
               ...
               <div class="row">
                  <div class="col-md-12 col-sm-12">
                     <div class="card">
                        ...
                        <!-- BASIC FORM ELEMENTS -->
                        <!--===================================================-->
                        <form:form action="updateZone" modelAttribute="zone" autocomplete="off" method="post">
                        ...
                        <div class="card-body">
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-12 col-md-6 col-xl-4">
                                 <button class="btn btn-primary mb-1" id="btnUpdateId" tabindex="8">Update</button>
                                 <button class="btn btn-danger mb-1" type="button" id="btnCancelId" onclick="return cancel()" tabindex="9">Cancel</button>
                              </div>
                           </div>
                        </div>
                        </form:form>
