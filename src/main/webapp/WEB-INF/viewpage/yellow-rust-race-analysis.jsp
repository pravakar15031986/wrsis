                     ...
                     <div class="card">
                        <div class="card-header">
                           <ul class="nav nav-tabs nav-fill" role="tablist">
                              <a class="nav-item nav-link active"  href="yellow-rust-race-analysis">Pending Samples</a>
                              ...
                              <table data-toggle="table" class="table table-hover table-bordered">
                                 ...
                                 <tbody>
                                    <tr>
                                       ...
                                       <td>1</td>
                                       <td><a href="viewsurvey"><b>S1001</a></b></td>
                                       <td><b>HS-13123</b></td>
                                       <td>01-Sep-2019</td>
                                       <td>Yellow Rust</td>
                                       <td>03-Sep-2019</td>
                                       ...
                                       <td><a class="btn btn-info btn-sm" data-toggle="tooltip"  title="" href="yellowRustRaceAnalysisDetails" data-original-title="View Details"><i class="icon-edit1"></i></a>
                                       </td>
                                    </tr>
                                    <tr>
