            ...
            <div class="section">
               <div class="page-title">
                  <div class="title-details">
                     <h4>View Details Recommendation Survey</h4>
                  ...
                  <div class="col-md-12 col-sm-12">
                     <div class="card">
                        ...
                        <div class="card-body">
                           ...
                           <!--Static-->
                            <b style="font-size: 20px;" >Monitor No. : <span id="monitorno"></span> & Monitor Date : <span id="monitordate"></span></b>
					   ...
					   <div class="tablesec">
					    ...
					    <table id="dataTable1" width="100%" border="0" cellspacing="0" cellpadding="0" class="table table-bordered">
							<tr>
                              ...
                              <div class="form-group row" >
							  <div class="col-12 col-md-8 col-xl-8">
								 <a href="viewImplementation" class="btn btn-danger mb-1" onclick="history.back()" >Back</a>
							  </div>
...
$("#monitorno").html(json[0].montNo);
$("#monitordate").html(json[0].montDate);
console.log(json);
