...
<div class="mainpanel">
  <form action="viewworeda" method="get" id="cancelForm"><input type="hidden" name="csrf_token_" value="<c:out value='${csrf_token_}'/>"/></form>
            <div class="section">
               ...
               <div class="row">
                  <div class="col-md-12 col-sm-12">
                     <div class="card">
                        ...
                        <!-- BASIC FORM ELEMENTS -->
                        <!--===================================================-->
                        <form:form action="updateWoreda" modelAttribute="woreda" autocomplete="off" method="post">
                        ...
                        <div class="card-body">
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-12 col-md-6 col-xl-4">
                                 <button class="btn btn-primary mb-1" id="btnUpdateId" tabindex="9">Update</button>
                                 <button id="btnCancelId" type="button" class="btn btn-danger mb-1" tabindex="10" onclick="return cancel()">Cancel</button>
                              </div>
                           </div>
                        </div>
                        </form:form>
