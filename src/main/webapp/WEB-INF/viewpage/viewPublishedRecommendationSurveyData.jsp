            ...
            <div class="section">
               ...
               <div class="row">
                  <div class="col-md-12 col-sm-12">
                     <div class="card">
                        <div class="card-header">
                           <ul class="nav nav-tabs nav-fill" role="tablist">
                                <a class="nav-item nav-link active" href="viewPublishedRecommendationSurveyData">Published</a>
                                <a class="nav-item nav-link" href="viewDiscardedRecommendationSurveyData">Discarded</a>
                           </ul>
                     ...
                     <div class="indicatorslist"> 
                         <form action="downloadRecomendationSurveyDataDetailsWePublishedPdf" method="post" target="_blank" id="pdfform" class="noload">
...
<input type="hidden" name="csrf_token_" value="<c:out value='${csrf_token_}'/>"/>
					...
					<form action="downloadRecomendationSurveyDataDetailsWePublishedExcel" method="post" id="exceldownload">
                        ...
                        <!-- Search Panel -->
                         <div class="search-container">
                           <div class="search-sec">
                            <form:form action="viewPublishedRecommendationSurveyData" modelAttribute="searchVo" autocomplete="off"   method="post"  id="searchForm">
...
$(function() {
	...
	$('#viewTable').dataTable({
	      ...
	      "ordering": false, 
			 "ajax" : {
					"url" : "viewMonitorPublishedDataByUserId",
					"data" : function(d) {
...
function searchData(){
	...
	if(fromDate!='' &&  toDate!='')
	{
		...
		{
			$("#fromDate").focus();
			swal('Error!','Monitor Date From Should not be greater than Moniter Date To','error')
				return false; 
		}
	}
	form.submit();	
