...
<div class="mainpanel">
            ...
            <div class="section">
               ...
               <form action="pendingrecommendation" method="get" id="cancelForm">
               ...
               <div class="row">
                  <div class="col-md-12 col-sm-12">
                     <div class="card">
                        ...
                        <div class="card-body">
                          <form action="add-recommendationApp"  method="post"  onsubmit="return false" enctype="multipart/form-data">
                          <input type="hidden" name="csrf_token_" value="<c:out value='${csrf_token_}'/>"/>
