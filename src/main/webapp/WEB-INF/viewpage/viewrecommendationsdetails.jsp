                     ...
                     <div class="card">
                        <div class="card-header">
                           <ul class="nav nav-tabs nav-fill" role="tablist">
                              <a class="nav-item nav-link active"  href="viewrecommendationsdetails .html">View</a>
                           </ul>
					   ...
					   <table class="table  table-bordered">
					      ...
					      <tbody>
					      <tr>
						      <td><input type="text" id="maleId" class="form-control" placeholder="" onblur="calculationtotalFarmers()" value="75" disabled="disabled"></td>
						      <td><input type="text" id="femaleId" class="form-control" placeholder="" onblur="calculationtotalFarmers()" value="3" disabled="disabled"></td>
						      <td><input type="text" id="total" class="form-control" placeholder=""  readonly="readonly" value="78"></td>
					       </tr>
					     </tbody>
					    </table> 
