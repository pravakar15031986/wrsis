 ...
 <div class="mainpanel">
        ...
        <div id="imageShow">   
	                       ...
	                       <div class="row noimage">
			                       ...
			                       <a href="${images }" data-thumbnail="${images }" data-group="mygroup" class="html5lightbox thumbimg" title="Toronto">  <img alt="no_img" src="${images }" style="width: 160px;height:160px;"></a>
														</c:forEach>
