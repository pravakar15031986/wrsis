                  ...
                  <div class="title-details">
                     ...
                     <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                           ...
                           <li class="breadcrumb-item">Publish Survey</li>
                        </ol>
                     </nav>
                  </div>
              <script>
                          ...
                          <div class="width50">
                           ...
                           <div class="width50">
                            ...
                            <div class="form-group row" id="kebelworedaaddrdiv">
                              <label class="col-12 col-md-4 col-xl-4 control-label" for="demo-email-input">Location Name <!--  --></label>
                              <div class="col-12 col-md-8 col-xl-8">
                                 <span class="colon">:</span>
                        ...
                        <div class="width50">
                          ...
                          <div class="width50">
                            ...
                            <div class="clearfix"></div>
                       	  ...
                       	  <form action="saveSurveyDetails" autocomplete="off" id="myForm"   method="post">
...
<input type="hidden" name="csrf_token_" value="<c:out value='${csrf_token_}'/>"/>
                          ...
                          <input type="hidden"   name="r_url" value="viewsurveyDetailsOnPending">
                           </form>
