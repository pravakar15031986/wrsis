	...
	<div class="section">
		<div class="page-title">
			<div class="title-details">
				<h4>View Pathologist Details</h4>
				<nav aria-label="breadcrumb"> 
					<ol class="breadcrumb">
						<li class="breadcrumb-item"><a href="Home"><span
								class="icon-home1"></span></a></li>
						<li class="breadcrumb-item">Dashboard</li>
						<li class="breadcrumb-item active" aria-current="page">Pathologists</li>
					</ol>
				</nav>
			</div>
				...
				<div class="card">
					<div class="card-header">
						<ul class="nav nav-tabs nav-fill" role="tablist">
							<a class="nav-item nav-link active" href="pathologistReport">View</a>
						</ul>
						...
						<div class="indicatorslist excel">
                                <form action="downloadPathologistReportExcel" method="post" id="excelDownloadForm">
 						<input type="text" style="display:none;" name="rcId" id="rcIdExcel">
                        ...
                        <div class="indicatorslist pdf">
                            <form action="downloadPathologistReportPdf" method="post" id="pdfDownloadForm" target="_blank">         
 						<input type="hidden" name="csrf_token_" value="<c:out value='${csrf_token_}'/>"/>
 						<input type="text" style="display:none;" name="rcId" id="rcIdPdf">
					...
					<!-- Search Panel -->
					<form:form class="col-sm-12 form-horizontal customform" action="pathologistReport"  method="post" modelAttribute="searchVo" autocomplete="off">
					<input type="hidden" name="csrf_token_" value="<c:out value='${csrf_token_}'/>"/>
								...
								<thead>
									<tr>
								     ...
								     <tbody ><!-- userdetails -->
								       ...
								       <c:forEach items="${pathologistDetails}" var="dtls" varStatus="counter">
                                    <tr >
...
<script>
	$(document).ready(function(){
		...
		$("#excelDownload").click(function(){
			$("#rcIdExcel").val($("#researchCenterId").val())
		...
		$("#pdfDownload").click(function(){
			$("#rcIdPdf").val($("#researchCenterId").val())
	...
	<script>
	if(${fn:length(pathologistDetails)}==0)
		{
		$(".excel,.pdf").hide()
		}
	</script>