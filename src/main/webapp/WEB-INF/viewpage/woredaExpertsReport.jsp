	...
	<div class="section">
		<div class="page-title">
			<div class="title-details">
				<h4>View Woreda Experts Details</h4>
				<nav aria-label="breadcrumb"> 
					<ol class="breadcrumb">
						<li class="breadcrumb-item"><a href="Home"><span
								class="icon-home1"></span></a></li>
						<li class="breadcrumb-item">Dashboard</li>
						<li class="breadcrumb-item active" aria-current="page">Woreda Experts</li>
					</ol>
				</nav>
			</div>
				...
				<div class="card">
					<div class="card-header">
						<ul class="nav nav-tabs nav-fill" role="tablist">
							<a class="nav-item nav-link active" href="woredaExpertsReport">View</a>
						</ul>
						...
						<div class="indicatorslist excel">
                                <form action="downloadWoredaExpertReportExcel" method="post" id="excelDownloadForm">
                        ...
                        <div class="indicatorslist pdf">
                            <form action="downloadWoredaExpertReportPdf" method="post" id="pdfDownloadForm" target="_blank">         
					...
					<!-- Search Panel -->
					<form:form class="col-sm-12 form-horizontal customform" action="woredaExpertsReport"  method="post" modelAttribute="searchVo" autocomplete="off">
								...
								<thead>
									<tr>
								     ...
								     <tbody ><!-- userdetails -->
								       ...
								       <c:forEach items="${woredaExpertDetails}" var="dtls" varStatus="counter">
                                    <tr >
...
<script>
	...
	<script>
	if(${fn:length(woredaExpertDetails)}==0)
	{
		$(".excel,.pdf").hide()
		} 
	</script>