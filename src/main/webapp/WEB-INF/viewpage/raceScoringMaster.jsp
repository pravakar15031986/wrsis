                     ...
                     <div class="card">
                        <div class="card-header">
                           <ul class="nav nav-tabs nav-fill" role="tablist">
                              <a class="nav-item nav-link active"  href="raceScoringMaster">Add</a>
                        ...
                        <div class="card-body">
                           ...
                           <div class="form-group row" >
                              ...
                              <div class="col-12 col-md-8 col-xl-8"><span class="colon">:</span>
                                 <form:input  id="infectionId" path="infectionType" maxlength="3"  class="form-control" tabindex="2"/>
                              </div>
                           </div>
						  ...
						  <div class="form-group row">
							  ...
							  <div class="col-12 col-md-8 col-xl-8">
								 <button class="btn btn-primary mb-1" id="btnSubmitId" onclick="return save();" tabindex="6">Submit</button>
								 <button class="btn btn-danger mb-1" type="reset" id="btnResetId" tabindex="7">Reset</button>
							  </div>
					      </div>
                         </form:form>
                        </div> 
 ...
 <script type="text/javascript">
      ...
      function save()
      {
	   	 ...
	   	 if(infectionId=='')
		 {
	   	 ...
	   	 var function_regex = /^[0-9;+-]+$/;
	   	if(!infectionId.match(function_regex))
    	{
	   		swal(
					'Error',
					'Please enter valid infection type',
					'error'
					).then(function() 
			   		   		{
						$("#infectionId").focus();
