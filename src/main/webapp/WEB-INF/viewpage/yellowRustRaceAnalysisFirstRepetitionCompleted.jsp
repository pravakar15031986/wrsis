                     ...
                     <div class="card">
                        <div class="card-header">
                           <ul class="nav nav-tabs nav-fill" role="tablist">
                              <a class="nav-item nav-link active"  href="yellowRustRaceAnalysisPendingDetails">Add</a>
                           </ul>
                        ...
                        <div class="card-body">
                          ...
                          <div class="width50">
                           ...
                           <div class="form-group row">
                              <label class="col-12 col-md-4 col-xl-4 control-label" for="demo-email-input">Rust Analysis</label>
                              <div class="col-12 col-md-8 col-xl-8">
                                 <span class="colon">:</span>
                                  Yellow Rust
                              </div>
  ...
  $(".sampleyes").click(function(){
	...
	// Modify
	 ...
	 $(document).on('click', '#btnModifyId', function(e) {
		    swal({
		    	...
		    	.then((result) => {
					if (result.value) {
						window.location.href="yellowRustRaceAnalysisFirstRepetitionCompleted";
	...
	/* 	 if(recordingDateVal == ''){
		    ...
		    swal({
		    	...
		    	.then((result) => {
					if (result.value) {
						window.location.href="yellowRustinoculatedsample";
					} else if (result.dismiss === 'cancel') {
					    swal(
					      'Cancelled',
					      'Your stay here :)',
