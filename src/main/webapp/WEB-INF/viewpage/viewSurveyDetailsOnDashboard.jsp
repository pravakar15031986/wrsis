                  ...
                  <div class="col-md-12 col-sm-12">
                     <div class="card">
                           ...
                           <div class="indicatorslist">
                             <a title="" href="${r_url}" onclick="history.back();" data-toggle="tooltip" data-placement="top" data-original-title="Back"><i class="icon-arrow-left1"></i></a>
                           </div>
                        </div>
                          ...
                          <div class="width50">
                            ...
                            <div class="form-group row">
							  ...
							  <div class="col-12 col-md-8 col-xl-8">
								 ...
								 <a class="btn btn-success mb-1" id="btnBack" href="${r_url}" onclick="history.back()">Back</a>
							  </div>
					      </div>
