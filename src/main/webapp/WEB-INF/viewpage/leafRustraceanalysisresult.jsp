                     ...
                     <div class="card">
                        <div class="card-header">
                           <ul class="nav nav-tabs nav-fill" role="tablist">
                              <a class="nav-item nav-link"  href="leaf-rust-race-analysis">Pending Samples</a>
                              <a class="nav-item nav-link"  href="leafRustinoculatedsample">Inoculated Sample</a>
                              <a class="nav-item nav-link active"  href="leafRustraceanalysisresult">Race Analysis Result</a>
                           </ul>
                        ...
                        <div class="card-body">
                              ...
                              <table data-toggle="table" class="table table-bordered">
                                 ...
                                 <tbody>
                                    <tr>
                                       <td rowspan="2">1</td>
                                       <td rowspan="2"><b><a href="viewsurvey">S1001</b></a></td>
                                       <td rowspan="2"><b>HS-13123</b></td>
                                       <td rowspan="2">Leaf Rust</td>
                                       ...
                                       <td align="center"><a data-toggle="tooltip" href="viewLeafRustRaceAnalysisFirstRepetition" data-original-title="View Completed Repetition ">I</a></td>
                                       <td align="center">KTTTK</td>
                                       <td rowspan="2" class="text-center"><a  class="btn btn-info btn-sm" data-toggle="tooltip"   title="" href="leafRustRaceAnalysisFinalResult" data-original-title="View Details"><i class="icon-edit1"></i></a>
                                          
                                       </td>
                                       <td rowspan="2" align="center">--</td>
                                    </tr>
                                     <tr>
                                       <td align="center"><a data-toggle="tooltip" href="viewLeafRustRaceAnalysisSecondRepetition" data-original-title="View Completed Repetition ">II </a></td>
