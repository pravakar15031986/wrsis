                              ...
                              <div class="col-12 col-md-8 col-xl-8"><span class="colon">:</span>
                               <div class="row">
                                    <div class="col-12 col-md-12 col-xl-12">
                                      <input type="text"  autocomplete="off"  id="latitudeId" class="form-control" placeholder="Enter decimal value">
                                   </div>
	             ...
	             <div class="radio">
	                ...
	                <label for="demo-form-radio-6">No</label>
                          ...
                          <div class="table-responsive">
      							    ...
      							    <form action="validateSurveyDetailsDiscardSurveyor" autocomplete="off" id="myForm"   method="post" enctype="multipart/form-data">
...
<script>
 ...
 //wheat type change
    	   ...
    	   $("#btnBack").click(function(){
    			...
    			window.location.href="surveyDiscardedReport";
    		});
