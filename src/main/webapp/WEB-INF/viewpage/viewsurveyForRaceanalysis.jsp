                  ...
                  <div class="title-details">
                     ...
                     <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                           ...
                           <li class="breadcrumb-item active" aria-current="page">Manage Race Analysis</li>
                           <li class="breadcrumb-item">Race Analysis</li>
                        </ol>
                     </nav>
                  </div>
	            ...
	            <span id="sampleCollected"></span>
                         ...
                         <div id="imageShow">   
	                        ...
	                        <div class="row noimage">
			                       ...
			                       <a href="${images }" data-thumbnail="${images }" data-group="mygroup" class="html5lightbox thumbimg" title="Toronto">  <img src="${images }" alt="image" style="width: 160px;height:160px;"></a>
														</c:forEach>
                          ...
                          <div class="width50">
                            ...
                            <div class="form-group row">
							  ...
							  <div class="col-12 col-md-8 col-xl-8">
								 ...
								 <button class="btn btn-success mb-1" id="btnBack" onclick="history.back()">Back</button>
							  </div>
					      </div>
