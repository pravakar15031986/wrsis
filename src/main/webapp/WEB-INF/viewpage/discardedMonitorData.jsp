            ...
            <div class="section">
               <div class="page-title">
                  <div class="title-details">
                     <h4>View Discarded Recommendations Survey</h4>
                        ...
                        <div class="card-header">
                           <ul class="nav nav-tabs nav-fill" role="tablist">
                              <a class="nav-item nav-link" href="viewMonitorImplementation">New</a>
                                ...
                                <a class="nav-item nav-link active"  href="discardedMonitorData">Discarded</a>
                           </ul>
                        ...
                        <!-- Search Panel -->
                         <div class="search-container">
                           <div class="search-sec">
                            <form action="monitorDiscardedSearch" autocomplete="off"   method="post"  id="searchForm">
