                     ...
                     <div class="card">
                        <div class="card-header">
                           <ul class="nav nav-tabs nav-fill" role="tablist">
                              <a class="nav-item nav-link "  href="addtypeoffungicide">Add</a>
                              <a class="nav-item nav-link active"  href="viewtypeoffungicide" >View</a>
                           </ul>
                        ...
                        <div class="search-container">
                           <div class="search-sec">
                                 ...
                                 <div class="row">
                                    <label class="col-lg-2 ">Fungicide Name</label>
                                    <div class="col-lg-3">
                                       <input type="text" class="form-control" id="name" name="fullName" value="${name}" placeholder="" data-bv-field="fullName" maxlength="50">
                                    </div>
						...
						<div style="float: right;" id="pageId">
                           ...
                           <form action="edittypeoffungicide" id="editForm" method="post">
                         
<input type="hidden" name="csrf_token_" value="<c:out value='${csrf_token_}'/>"/>

                           <input type="hidden" id="id" name="fungiId">
                           </form>
                           <form action="search-fungicide" method="post" id="searchForm">
                           		
<input type="hidden" name="csrf_token_" value="<c:out value='${csrf_token_}'/>"/>

                           		<input type="hidden" id="nameId" name="fungiName">
	...
	$.ajax({
			...
			success:function(response){
				...
				for(var i=array0.startPage;i<=array0.endPage;i++)
				{
				 ...
				 if(val!=" " || val!=null )
				{
					 listDataLen=listDataLen+val.fungiList.length-backUp;
  					 var dataLen=val.fungiList.length;
					 var indexLen=listDataLen-dataLen;
					
					$.each(val.fungiList,function(index,value)
					{
...
function searchData(pSize,pageNumber){
	...
	var name_regex = /^[a-zA-Z ]{0,50}$/;
	 if(!name.match(name_regex))
  	{
  		swal("Error", "Fungicide Name accept only alphabets", "error").then(function() {
				   $("#name").focus();
			   });
			return false;
  	}
