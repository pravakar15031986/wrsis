...
<div class="mainpanel">
 <form action="viewsampletype" method="get" id="cancelForm"><input type="hidden" name="csrf_token_" value="<c:out value='${csrf_token_}'/>"/></form>
            <div class="section">
               ...
               <div class="row">
                  <div class="col-md-12 col-sm-12">
                     <div class="card">
                        ...
                        <!-- BASIC FORM ELEMENTS -->
                        <!--===================================================-->
                        <form:form action="save-sample-type" modelAttribute="sample" method="post" onsubmit="return false;" autocomplete="off">
                        ...
                        <div class="card-body">
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-12 col-md-6 col-xl-4"><span class="colon">:</span>
                                 <form:input tabindex="1"  id="demo-text-input1" path="sampleName" class="form-control" placeholder="Sample Type" maxlength="50"/>
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-12 col-md-6 col-xl-4"><span class="colon">:</span>
                                 <form:textarea tabindex="2" id="description" rows="4" class="form-control" path="description" placeholder="Description" maxlength="200" onkeyup="countChar(this)"/><div id="charNum">Maximum 200 characters</div>
                              </div>
                           </div> 
                             <div class="form-group row pad-ver">
                              ...
                              <span class="colon">:</span>
                                 <div class="radio">
                                    <form:radiobutton id="demo-form-radio" class="magic-radio sampleyes" path="status" value="false" name="form-radio-button" />
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-12 col-md-6 col-xl-4">
                                 <button id="btnUpdateId" class="btn btn-primary mb-1" tabindex="5">Update</button>
                                 <button  class="btn btn btn-danger mb-1" id="btnCancelId" onclick="cancel()" tabindex="6">Cancel</button>
                              </div>
                           </div>
                        </div>
                        </form:form>
