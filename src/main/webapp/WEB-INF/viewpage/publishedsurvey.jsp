...
<div class="mainpanel">
               ...
               <div class="row">
                  <div class="col-md-12 col-sm-12">
                     <div class="card">
                        <div class="card-header">
                           <ul class="nav nav-tabs nav-fill" role="tablist">
                              ...
                              <a class="nav-item nav-link active"  href="publishedsurvey">Published Survey</a>
                    ...
                    <div class="indicatorslist">
                           ...
                           <form action="downloadPublishedSurveyExcel" method="post" id="exceldownload">
                       <input type="hidden" name="csrf_token_" value="<c:out value='${csrf_token_}'/>"/>
                        ...
                        <button title="Excel" class="btn btn-outline-success btn-sm shadow-none"><i class="icon-excel-file" ></i></button>
                           ...
                           <div class="indicatorslist">
                           <form action="downloadPublishedSurveyPdf" method="post" id="pdfform" target="_blank">
                       <input type="hidden" name="csrf_token_" value="<c:out value='${csrf_token_}'/>"/>
                       ...
                       <form action="searchSurveyDetailsPublishedByStatus" autocomplete="off"   method="post" id="searchForm">
                           <input type="hidden" name="csrf_token_" value="<c:out value='${csrf_token_}'/>"/>
          ...
          <form action="viewsurveyDetailsOnPending" id="myForm1" method="post">
          <input type="hidden" name="csrf_token_" value="<c:out value='${csrf_token_}'/>"/>
          	<input type="text" value="" style="display:none;" name="surveyId" id="surveyId1">
          	<input type="hidden"   name="r_url" value="publishedsurvey">
          </form>
...
$(function() {
	...
	$('#viewTable').dataTable({
	      ...
	      "ordering": false, 
			 "ajax" : {
					"url" : "publishedSurveyDataPageWise",
					"data" : function(d) {
