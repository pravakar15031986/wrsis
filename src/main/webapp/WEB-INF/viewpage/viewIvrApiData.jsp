...
<div class="mainpanel">
            <div class="section">
               <div class="page-title">
                   <div class="title-details">
                     <h4>View IVR API Log Data</h4>
                     <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                           <li class="breadcrumb-item"><a href="Home"><span class="icon-home1"></span></a></li>
                          <li class="breadcrumb-item">Log Reports</li>
                           <li class="breadcrumb-item active" aria-current="page">IVR API LOG</li>
                        </ol>
                     </nav>
                  </div>
                     ...
                     <div class="card">
                        <div class="card-header">
                           <ul class="nav nav-tabs nav-fill" role="tablist">
                              ...
                              <a class="nav-item nav-link active"  href="viewIvrApiLogData">View</a>
                           </ul>
                        ...
                        <form:form class="col-sm-12 form-horizontal customform"
								action="viewIvrApiLogDataSearch" method="post"
   ...
   <div class="modal fade" id="reponseDtlsModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h6 class="modal-title" id="exampleModalLabel">Response Details</h6>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body" id="contentPoup">
...
<script>
 ...
 function viewApiResponse(responseDtls){
	 data = JSON.parse(atob(responseDtls));
	 $("#modalcontent").html(JSON.stringify(data));
	 $('#reponseDtlsModal').modal('show');
