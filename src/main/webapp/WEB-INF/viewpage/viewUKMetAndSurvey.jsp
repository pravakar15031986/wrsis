			...
			<div class="col-md-12 col-sm-12">
				...
				<div class="card-header">
						...
						<ul class="nav nav-tabs nav-fill" role="tablist">
							<a class="nav-item nav-link active" href="viewUKMetAndGlobalRustAPILog">View UKMet And Survey</a>
						</ul>
					...
					<div class="search-container">
						...
						<div class="search-sec">
							...
							<form:form class="col-sm-12 form-horizontal customform"
								action="viewUKMetAndGlobalRustAPILog" method="post"  
...
function validate(){
	...
	{	
		...
		{
			$("#endDate").focus();
			swal('Warning','Please enter Request To Date','warning')
   			return false; 
		}
	}
	...
	{	
		...
		{
			$("#startDate").focus();
			swal('Warning','Please enter Request From Date','warning')
   			return false; 
		}
	}
	if(fromDate!='' &&  toDate!='')
	{
		...
		{
			$("#startDate").focus();
			swal('Warning','Request From Date Should be less than Request To Date','warning')
				return false; 
		}
	}
