                  ...
                  <div class="title-details">
                     ...
                     <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                           ...
                           <li class="breadcrumb-item">Recommendation Survey Data</li>
                     ...
                     <div class="card">
                        <div class="card-header">
                           ...
                           <div class="indicatorslist">
                              <a  title="" href="javascript:void(:)" id="backIcon" data-toggle="tooltip" data-placement="top" data-original-title="Back" onclick="history.back()"><i class="icon-arrow-left1"></i></a>
                           </div>
                        </div>
