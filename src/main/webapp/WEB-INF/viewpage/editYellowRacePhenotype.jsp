            ...
            <div class="section">
               <div class="page-title">
                  <div class="title-details">
                     <h4>Edit Yellow Rust Race Phenotype</h4>
               ...
               <div class="row">
                  <div class="col-md-12 col-sm-12">
                     <div class="card">
                        ...
                        <form:hidden path="racePhenotypeId"/>
                        <div class="card-body">
                           <!--Static-->
                           <!--Text Input-->
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-12 col-md-6 col-xl-4">
                                 <button id="btnUpdateId" class="btn btn-primary mb-1" type="button" tabindex="5">Update</button>
                                 <a href="viewYellowRacePhenotype" id="btnCancelId" class="btn btn btn-danger mb-1" tabindex="6">Cancel</a>
