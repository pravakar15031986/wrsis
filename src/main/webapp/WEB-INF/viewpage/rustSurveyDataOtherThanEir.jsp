               ...
               <div class="row">
                  <div class="col-md-12 col-sm-12">
                    ...
                    <div class="indicatorslist">
                              ...
                              <a  title="" href="javascript:void(0)"   id="excelIcon" data-toggle="tooltip" data-placement="top" data-original-title="Excel" onclick="downloadExcel()"><i class="icon-excel-file"></i></a>
