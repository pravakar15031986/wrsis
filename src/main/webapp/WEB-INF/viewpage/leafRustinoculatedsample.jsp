                     ...
                     <div class="card">
                        <div class="card-header">
                           <ul class="nav nav-tabs nav-fill" role="tablist">
                              ...
                              <a class="nav-item nav-link active"  href="leafRustinoculatedsample">Inoculated Sample</a>
                              ...
                              <table data-toggle="table" class="table table-hover table-bordered">
                                 ...
                                 <tbody>
                                    <tr>
                                       ...
                                       <td><a class="btn btn-info btn-sm" data-toggle="tooltip"  title="" href="leafRustRaceAnalysisNewDetails" data-original-title="View Details"><i class="icon-edit1"></i></a>
                                    ...
                                    <tr>
                                       ...
                                       <td>Dawa Chefa</td>
                                       <td>Kemise Akababi</td>
                                       <td>1st Repeatition completed <br>(on differentials)</td>
                                       <td><a class="btn btn-info btn-sm" data-toggle="tooltip"  title="" href="leafRustRaceAnalysisFirstRepetitionCompleted" data-original-title="View Details"><i class="icon-edit1"></i></a>
                                       </td>
                                    </tr>
                                       ...
                                       <td>2nd Repeatition completed <br>(on differentials)</td>
                                       <td><a class="btn btn-info btn-sm" data-toggle="tooltip"  title="" href="leafRustRaceAnalysisPendingDetails" data-original-title="View Details"><i class="icon-edit1"></i></a>
                                       </td>
                                    </tr>
