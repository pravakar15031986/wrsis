				...
				<div class="card">
					<div class="card-header">
						<ul class="nav nav-tabs nav-fill" role="tablist">
							...
							<a class="nav-item nav-link " href="viewImplementation">View</a>
					...
					<form:form class="col-sm-12 form-horizontal customform"
						action="woredaExpertImplementation" method="post"
								...
								<div class="form-group">
									<div class="row">
										...
										<div class="input-group col-lg-3">
											<form:input type="text" id="recDtFrom" path="recDtFrom" data-date-end-date="0d"
										...
										<div class="input-group col-lg-3">
											<form:input type="text" id="recDtTo" path="recDtTo" data-date-end-date="0d"
												class="form-control datepicker" aria-label="Default"
												aria-describedby="inputGroup-sizing-default" />
											<div class="input-group-append">
												<span class="input-group-text"
							...
							<table data-toggle="table"
								...
								<thead>
									<tr>
										...
										<th class="text-center">Add Implementation Details</th>
									</tr>
								</thead>
								<tbody>
									<%-- <c:forEach items="${recommendation}" var="rec"
										...
										<tr>
											...
											<td class="text-center"><a title="" href="#" data-toggle="" data-placement="top" onclick="addImplementation('${rec.recomendId}','${rec.recomendNoBean}')"  data-original-title="Add"><i class="fa fa-plus-square fa-2x" aria-hidden="true"></i></a></td>
										</tr>
									</c:forEach> --%>
								</tbody>
							</table>
...
<input type="hidden" name="csrf_token_" value="<c:out value='${csrf_token_}'/>"/>
 ...
 <form:form action="woredamonitorrecommendations" name="form" method="post">
<input type="hidden" name="csrf_token_" value="<c:out value='${csrf_token_}'/>"/>

 
<input type="hidden" name="recomId" id="hdnrecomid"/>
<input type="hidden" name="recomno" id="hdnrecomno"/>
</form:form>
<script>
$(document).ready(function(){
	$('#viewMonitor').dataTable({
      ...
      "ordering": false, 
		 "ajax" : {
				"url" : "viewAddMonitorRecommendation",
				"data" : function(d) {
					d.recDtFrom= $("#recDtFrom").val();
					d.recDtTo = $("#recDtTo").val();
					d.recNo =$("#recNo").val();
				}
		},
		"dataSrc": "",
...
<script>
function addImplementation(recomid,recomno)
{	
$("#hdnrecomid").val(recomid);
$("#hdnrecomno").val(recomno);
