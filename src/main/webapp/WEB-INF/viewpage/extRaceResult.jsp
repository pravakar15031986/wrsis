            ...
            <div class="section">
               <div class="page-title">
                  <div class="title-details">
                     <h4>View External Race Result</h4>
                     ...
                     <div class="card">
                        <div class="card-header">
                           <ul class="nav nav-tabs nav-fill" role="tablist">
                              <a class="nav-item nav-link "  href="externalTaggedSamples">External Tagged Samples</a>
                              <a class="nav-item nav-link active"  href="extRaceResult">External Race Result</a>
                           </ul>
                             
                        </div>
                        <!-- Search Panel -->
                        <form class="col-sm-12 form-horizontal customform" action="extRaceResult"  method="post"  autocomplete="off">
                        ...
                        <div class="search-container">
                           ...
                           <div class="form-group">
                              ...
                              <label class="col-lg-2 ">Sample ID</label>
                                    <div class="col-lg-3">
                                       <input type="text" class="form-control" name="sampleId" id="sampleId" placeholder=""  maxlength="50"/>
                                    </div>
                              <label class="col-lg-2 ">Survey No.</label>
                                    <div class="col-lg-3">
                                       <input type="text" class="form-control" name="surveyNo" id="surveyNo"   placeholder="" maxlength="50"/>
                                    </div>
                              </div>
                              </div>
                           </div>
