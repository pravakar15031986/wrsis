                  ...
                  <div class="col-md-12 col-sm-12">
                     <div class="card">
                           ...
                           <div class="indicatorslist">
                             <a title="" href="${r_url}" id="backIcon" data-toggle="tooltip" data-placement="top" onclick="history.back()" data-original-title="Back"><i class="icon-arrow-left1"></i></a>
                           </div>
                        </div>
                          ...
                          <div class="width50">
                            ...
                            <div class="form-group row">
							  ...
							  <div class="col-12 col-md-8 col-xl-8">
								 ...
								 <button class="btn btn-success mb-1" id="btnBack">Back</button>
							  </div>
					      </div>
...
$("#btnBack").click(function(){
	 var backurl="${r_url}";
	 if(backurl=='' || backurl== null)backurl="rustSurveyData"
