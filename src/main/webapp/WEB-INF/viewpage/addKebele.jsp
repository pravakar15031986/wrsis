                     ...
                     <div class="card">
                        <div class="card-header">
                           <ul class="nav nav-tabs nav-fill" role="tablist">
                              <a class="nav-item nav-link active"  href="addkebele">Add</a>
                        ...
                        <!-- BASIC FORM ELEMENTS -->
                        <!--===================================================-->
                         <form:form action="add-kebele" modelAttribute="kebele" autocomplete="off" method="post">
                        ...
                        <div class="card-body">
                           ...
                           <!--Text Input-->
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-12 col-md-6 col-xl-4"><span class="colon">:</span>
                                 <form:textarea path="description" id="description" rows="4" tabindex="7" class="form-control" placeholder="Description" maxlength="100" /><div id="charNum"></div>
                              </div>
                           </div>
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-12 col-md-6 col-xl-4">
                                 <button class="btn btn-primary mb-1" id="btnSubmitId" tabindex="10">Submit</button>
                                 <button type="reset" class="btn btn-danger mb-1" tabindex="11">Reset</button>
                              </div>
                           </div>
                        </div>
                        </form:form>
            	...
            	swal({
            		title: ' Do you want to submit?',
        	    	  ...
        	    	  if (result.value) {
        	    		  ...
        	    		  window.location.href="viewkebele";
        	    		  return true; */
        	    		  }
        	    		})
            }
