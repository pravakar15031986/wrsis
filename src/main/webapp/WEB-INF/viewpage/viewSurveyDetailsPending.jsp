                  ...
                  <div class="title-details">
                     ...
                     <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                           ...
                           <li class="breadcrumb-item">Published Survey Data</li>
                        </ol>
                     </nav>
                  </div>
	            ...
	            <span id="sampleCollected"></span>
                       ...
                       <div class="row noimage">
	                       ...
	                       <c:forEach items="${Images}" var="images"
							 ...
							 <div class="col-md-2">					
	                      <a href="${images}" data-thumbnail="${images}" data-group="mygroup" class="html5lightbox thumbimg" title="Syrvey Images">  <img alt="images" src="${images}" style="width: 160px;height:160px;"></a>
	                         </div>
												</c:forEach>
