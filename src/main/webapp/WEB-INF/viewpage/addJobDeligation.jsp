                     ...
                     <div class="card">
                        <div class="card-header">
                           <ul class="nav nav-tabs nav-fill" role="tablist">
                              <a class="nav-item nav-link active"  href="addJobDeligation">Add</a>
...
$(document).ready(function(){
	...
	$( "#organisationId" ).change(function() {
	   ...
	   $('#btnSubmitId').click(function(){
		   ...
		   if ($('#levelApproval').val() == "0"){
	        	swal("Error", "Level of Approval should not blank", "error");
	        	 $("#levelApproval").focus();
	            return false;
	        }
