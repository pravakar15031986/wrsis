...
<head>
         <title>demographicTaggingedit</title>
...
<%-- <c:if test="${tagging ne Empty}">
<script>
	
	
	
	alert("User Id=="+${tagging.userIdBean.userId});
	var t=
	serchLocationDetails(${tagging.userIdBean.userId});
	alert("Check it");
	</script>
</c:if> --%>
<script>
            ...
            <div class="section">
               <div class="page-title">
                  <div class="title-details">
                     <h4>Edit User Location Tagging</h4>
                  ...
                  <div class="col-md-12 col-sm-12">
                     <div class="card">
                        ...
                        <div class="card-body">
                           ...
                           <form action="update-demography-tagging" method="post" id="centerMasterformId" onsubmit="return false">
                           <input type="hidden" name="csrf_token_" value="<c:out value='${csrf_token_}'/>"/>
                           <input type="hidden" name="tagId" value="${tagging.locationTagIdBean}">
                           <div class="form-group row">
                                    <label class="col-12 col-md-4 col-xl-4 control-label">Organization Name</label>
                                    <div class="col-12 col-md-8 col-xl-8">
                                     <span class="colon">:</span>
                                     <input type="text"  class="form-control" maxlength="50" value="${orgList}" readonly="readonly" tabindex="1" id="userEditResId"/>
                                     <%-- <input type="text" value="${orgListId}"> --%>
                                   </div>
                            </div>	
                        
                          <div class="form-group row">
                                    <label class="col-12 col-md-4 col-xl-4 control-label">Role Name</label>
                                    <div class="col-12 col-md-8 col-xl-8">
                                     <span class="colon">:</span>
                                     <input type="text"  class="form-control" maxlength="50" value="${roleName}" readonly="readonly" tabindex="2" id="userEditResId"/>
                                    <%--  <input type="text" value="${roleNameId}"> --%>
                                    </div>
                            </div>	
                            <div class="form-group row" id="userNames_show_1">
                                    <label class="col-12 col-md-4 col-xl-4 control-label">User Name</label>
                                    <div class="col-12 col-md-8 col-xl-8">
                                     <span class="colon">:</span>
                                      <input type="text"  class="form-control" maxlength="50" value="${tagging.userIdBean.fullName}" readonly="readonly" tabindex="3" id="userEditResId"/>
                                     <input type="hidden" value="${tagging.userIdBean.userId}" id="userIdEdit">	
                                     <%-- <select class="form-control" id="userId" name="userNameId"    onchange="serchLocationDetails(this.value);" tabindex="3"> 
                                    <option value="${tagging.userIdBean.userId}">${tagging.userIdBean.fullName}</option>
                                    </select> --%>
                            ...
                            <div class="form-group row">
                              <label class="col-12 col-md-4 col-xl-4 control-label" for="demo-email-input">Region Name </label>
                           	<div class="col-12 col-md-8 col-xl-8">
                                 <span class="colon">:</span>
						...
						<!-- Here get Region From the RC Location -->
						<div class="dropdown-container" id="Region_div_Id_2" tabindex="4">
                         ...
                         <div class="form-group row zone">
                              <label class="col-12 col-md-4 col-xl-4 control-label" for="demo-email-input">Zone Name </label>
                              <div class="col-12 col-md-8 col-xl-8">
                                 <span class="colon">:</span>
						...
						<div class="dropdown-container" id="Zone_div_Id_2" tabindex="5">
						    ...
						    <div class="dropdown-list" style="display: none;">
                                 ...
                                 <div class="form-group row woreda">
									...
									<div class="col-12 col-md-8 col-xl-8" id="ListBoxId_1">
										...
										<div class="subject-info-box-1">
											<select multiple="multiple" id="WoredaFirstZoneId" class="form-control lstBox1" tabindex="6">
											<c:forEach items="${tagging.totalWoridaBeanID }" var="woridName">
												
												<option value="${woridName.key }">${woridName.value}</option>
										  </c:forEach>
											</select>
										</div>
										...
										<div class="subject-info-box-2">
											<select multiple="multiple" id="woridaResultId" name="f_woredaId" class="form-control selectbox-scrollable lstBox1" tabindex="9">
												<c:forEach items="${tagging.checkWoridaBeanID }" var="woridaName">
									 ...
									 <div class="subject-info-box-2" style="height:108px; display: none;" >
											<select multiple="multiple" id="woridaResultIdInRCTagging"  class="form-control selectbox-scrollable lstBox1" tabindex="9">
												<c:forEach items="${tagging.checkWoridaBeanID }" var="woridaName">
									...
									<div class="col-12 col-md-8 col-xl-8" id="ListBoxId_2">
										...
										<!-- div For Arrow Start -->
										<div class="subject-info-arrows text-center">
											<input type="button" id='btnRight_2' value="+" class="btn btn-primary" tabindex="11"/>
											<input type="button" id='btnLeft_2' value="-" class="btn btn-danger" tabindex="12"/><br>
									...
									<div class="col-12 col-md-8 col-xl-8">
										...
										<div class="subject-info-box-1">
											<select multiple="multiple" id="kebeleFirstId" class="form-control selectbox-scrollable lstBox1" tabindex="14">
												<c:forEach items="${tagging.totalKebeleBeanID }" var="kebeName">
												
												<option value="${kebeName.key }">${kebeName.value}</option>
										  </c:forEach>
											</select>
										</div>
										<!-- div For Arrow Start -->
										...
										<div class="subject-info-box-2">
											<select multiple="multiple" id="kebeleResultId" name="f_kebeleId" class="form-control selectbox-scrollable lstBox1" tabindex="17">
												<c:forEach items="${tagging.checkKebeleBeanID }" var="kebeleName">
												
												<option value="${kebeleName.key }">${kebeleName.value}</option>
												</c:forEach>
											</select>
                              ...
                              <span class="colon">:</span>
                                 <div class="radio">
                                    <input type="radio" name="status" id="demo-form-radio" value="0" <c:if test="${(empty tagging.statusBean) or (tagging.statusBean=='false')}">checked="checked"</c:if>  class="magic-radio sampleyes"  name="form-radio-button"/>
                                    <label for="demo-form-radio" tabindex="18">Active</label>
                             
                                    <input type="radio" name="status" id="demo-form-radio-2" value="1" <c:if test="${tagging.statusBean=='true'}">checked="checked"</c:if> class="magic-radio sampleno"  name="form-radio-button" />
						  ...
						  <div class="form-group row">
							  ...
							  <div class="col-12 col-md-8 col-xl-8">
								 <button class="btn btn-primary mb-1" onclick="return save();" tabindex="20">Update</button>
								 <button class="btn btn-danger mb-1" type="reset" id="btnResetId" tabindex="21">Cancel</button>
							  </div>
					      </div>
                         </form>
                        </div>  
                          <form action="demographicTaggingView" method="get" id="viewformId">
			...
			success : function(response) {
				...
				if (val != "" || val != null) {
					...
					$.each(val,function(index, value) {
						...
						if(check==false)
						{	
							//console.log("IN else=="+value.zoneId);
							html=html+" <li><div class='checkbox'>";
...
$(document).ready(function()
{
	...
	serchLocationDetails(userId);
});
	 function serchLocationDetails(userId)
	{
	
		  var woredaOneArr=[];
			$('#woridaResultIdInRCTagging option').each(function() {
				woredaOneArr.push($(this).val());
			});
		  
			//alert("woredaOneArr=="+woredaOneArr);
		...
		$.ajax({
		   ...
		   data : {
			...
			success : function(response) {
				...
				var region="";
				var val=JSON.parse(response);
				//alert("val=="+val.locationList.length);
				...
				if(val.locationList.length>0 )
				{
					...
					$.each(val.locationList,function(index,value)
					{
						...
						alert("regionName=="+value.regionName); */
						 ...
						 region=region+"<input type='checkbox' id="+"region_"+value.regionId+" value="+value.regionId+"  class='magic-checkbox' name='regionId' checked/>";    
					...
					{
						var check = false;
						for(i=0;i<woredaOneArr.length;i++)
 	 					{
							if(woredaOneArr[i] == value.woredaId)
							{
								woredaRes_2=woredaRes_2+"<option value="+value.woredaId+" >"+value.woredaName+"</option>";
								check = true;
								break;
							}
 	 					}if(check == false)
		 				{
							woredaRes_1=woredaRes_1+"<option value="+value.woredaId+">"+value.woredaName+"</option>";
		 				}
					});
					
					$('#WoredaFirstZoneId_2').empty().append(woredaRes_1);
					$('#woridaResultId_2').empty().append(woredaRes_2);
					$("#ListBoxId_1").hide();
					$("#ListBoxId_2").show();
					$("#vlWoredaId").val("yes");
					//woredaListValidation(yes);
					//alert("Yes Taging With RC");
				}else{
...
<script type="text/javascript">
      ...
      function save()
      {
		...
		var userEditResId=$("#userEditResId").val();
		var roleId=${roleNameId};
    	//alert("userEditResId=="+userEditResId);	 
    	if(userEditResId=='0')
        {	
