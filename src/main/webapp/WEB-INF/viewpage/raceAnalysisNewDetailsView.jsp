	...
	<div class="section">
		...
		<div class="row">
			<div class="col-md-12 col-sm-12">
				<div class="card">
					<div class="card-header">
						<ul class="nav nav-tabs nav-fill" role="tablist">
							<a class="nav-item nav-link active" href="raceanalysisresult">View</a>
				...
				<c:if test="${i lt 5 and Result[i] ne null and Result[i] ne ''}">
							...
							<div class="form-group row">
                             ...
                             Upload File
                               ...
                               <a href="public/showDocument?path=${File }" target="new" download="Survey_Uploaded_Success_Data" type="application/pdf">
                               <i class="fa fa-file-pdf-o " width="50" height="50"></i>
                               </a>
                              </c:if>
                               <c:if test="${IsPDF eq false }">
                              <a href="public/showDocument?path=${File }" target="new">
