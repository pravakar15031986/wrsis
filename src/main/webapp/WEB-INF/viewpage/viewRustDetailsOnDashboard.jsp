                  ...
                  <div class="title-details">
                     ...
                     <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                           ...
                           <li class="breadcrumb-item">Rust Report</li>
                        </ol>
                     </nav>
                  </div>
              <script>
$(document).ready(function(){
	//alert("hi By Eir Admin Survey Data");
})
              </script>
               </div>
               <div class="row">
                  <div class="col-md-12 col-sm-12">
                     <div class="card">
                           ...
                           <div class="indicatorslist">
                             ...
                             <a title="" href="${r_url}" id="backIcon" data-toggle="tooltip" data-placement="top"  data-original-title="Back"><i class="icon-arrow-left1"></i></a>
                           </div>
                        </div>
                        ...
                        <div class="card-body">
                           ...
                           <b style="font-size: 20px;">Survey No : ${SurveyNo}</b>
                           </c:if>
                          ...
                          <div class="width50">
                           ...
                           <div class="width50">
                            <div class="form-group row pad-ver">
                              <label class="col-12 col-md-4 col-xl-4 control-label">Is Rust Affect ? </label>
                              <div class="col-12 col-md-8 col-xl-8">
                                 <span class="colon">:</span>
                                 <!-- Radio Buttons -->
	            ...
	            <span id="sampleCollected"></span>
                       ...
                       <div class="row noimage">
	                       ...
	                       <c:forEach items="${Images}" var="images"
												...
												<div class="col-sm-2">Uploaded Images</div>
												</c:if>
							 <div class="col-md-2">					
	                      <a href="${images}" data-thumbnail="${images}" data-group="mygroup" class="html5lightbox thumbimg" title="Syrvey Images">  <img src="${images}" alt="surveyImage" style="width: 160px;height:160px;"></a>
	                         </div>
												</c:forEach>
                        ...
                        <div class="width50">
                            ...
                            <div class="form-group row" style="display:none;">
                             ...
                             <div class="form-group row">
                              <label class="col-12 col-md-4 col-xl-4 control-label" for="demo-email-input">Remarks <!--  --></label>
                              <div class="col-12 col-md-8 col-xl-8">
                                 <span class="colon">:</span>
                                <span id="remark"></span>
                              </div>
                          ...
                          <div class="width50">
                            ...
                            <div class="clearfix"></div>
                       	  ...
                       	  <form action="viewrustDetailsOnDashboard" autocomplete="off" id="myForm"   method="post">
...
$("#btnBack").click(function(){
	...
	window.location.href="rustSurveyData";
});
	 ...
	 swal({
 		title: ' Do you want to Modify?',
 		  ...
 		  cancelButtonText: 'No',
	    	  ...
	    	  if (result.value) { 
	    		  window.location.href="modifySurvey?surveyId="+'${SurveyId}';
	    		  }
	    		})  
	    		return false; 
	});
	...
	swal({
 		title: ' Do you want to Cancel?',
 		  ...
 		  cancelButtonText: 'No',
	    	  ...
	    	  if (result.value) { 
	    		  window.location.href="cancelSurveyDetails";
	    		  }
	    		})  
	    		return false;   
});
