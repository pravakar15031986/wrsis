                     ...
                     <div class="card">
                        <div class="card-header">
                           <ul class="nav nav-tabs nav-fill" role="tablist">
                              ...
                              <a class="nav-item nav-link active"  href="yellowRustinoculatedsample">Inoculated Sample</a>
                              <a class="nav-item nav-link"  href="yellowRustraceanalysisresult">Race Analysis Result</a>
                           </ul>
                              ...
                              <table data-toggle="table" class="table table-hover table-bordered">
                                 ...
                                 <tbody>
                                    <tr>
                                       ...
                                       <td>Differentials Pending</td>
                                       <td><a class="btn btn-info btn-sm" data-toggle="tooltip"  title="" href="yellowRustRaceAnalysisNewDetails" data-original-title="View Details"><i class="icon-edit1"></i></a>
                                    ...
                                    <tr>
                                       ...
                                       <td>Dawa Chefa</td>
                                       <td>Kemise Akababi</td>
                                       <td>1st Repetition completed <br>(on differentials)</td>
                                       <td><a class="btn btn-info btn-sm" data-toggle="tooltip"  title="" href="yellowRustRaceAnalysisFirstRepetitionCompleted" data-original-title="View Details"><i class="icon-edit1"></i></a>
                                       </td>
                                    </tr>
                                    
                                       <tr>
                                       <td>3</td>
                                       <td><a href="viewsurvey"><b>S1003</b></a></td>
                                       <td><b>HS-13125</b></td>
                                       <td>Yellow Rust</td>
                                       <td>03-Sep-2019</td>
                                        <td>03-Oct-2019</td>
                                       ...
                                       <td>2nd Repetition completed <br>(on differentials)</td>
                                       <td><a class="btn btn-info btn-sm" data-toggle="tooltip"  title="" href="yellowRustRaceAnalysisPendingDetails" data-original-title="View Details"><i class="icon-edit1"></i></a>
                                       </td>
                                    </tr>
