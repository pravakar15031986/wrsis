...
public class SucessWebloginDetailsPDF {

	public static final Logger LOG = LoggerFactory.getLogger(SucessWebloginDetailsPDF.class);

	public ByteArrayInputStream generateSucessWebloginDetailsPDF(List<IPTrackBean> beans) {

		ByteArrayOutputStream out = new ByteArrayOutputStream();
		String[] cells = { "Sl No", "Organization Name", "User ID", "User Name", "Designation", "Role", "R.C. Name",
				"IP Address", "Login Date", "Status", "Logout Date" };
		...
		try {
			...
			Paragraph head = new Paragraph("Web Login Details",
			...
			LOG.error("SucessWebloginDetailsPDF::generateSucessWebloginDetailsPDF():" + e.getMessage());
		}
