...
public class PendingSurveyDetailsPDF {

	public static final Logger LOG = LoggerFactory.getLogger(PendingSurveyDetailsPDF.class);

	public ByteArrayInputStream generatePendingSurveyPdf(List<SurveyDetailsBean> beans) {

		ByteArrayOutputStream out = new ByteArrayOutputStream();
		String[] cells = { "Sl No", "Survey No", "Survey Date", WrsisPortalConstant.REGION, WrsisPortalConstant.ZONE, WrsisPortalConstant.WOREDA, WrsisPortalConstant.KEBELE,
				"Institution Name", "Type of Rus", "Mode of Data Collection" };
		...
		try {
			...
			Paragraph head = new Paragraph("Pending Survey",
			...
			LOG.error("PendingSurveyDetailsPDF::generatePendingSurveyPdf():" + e.getMessage());
		}
